...
"use strict";
eval("\n\n/* istanbul ignore next  */\nfunction insertStyleElement(options) {\n  var style = document.createElement(\"style\");\n  options.setAttributes(style, options.attributes);\n  options.insert(style);\n  return style;\n}\n\nmodule.exports = insertStyleElement;\n\n//# sourceURL=webpack://task02_conversion_types/./node_modules/style-loader/dist/runtime/insertStyleElement.js?");
...
"use strict";
eval("\n\n/* istanbul ignore next  */\nfunction setAttributesWithoutAttributes(style) {\n  var nonce =  true ? __webpack_require__.nc : 0;\n\n  if (nonce) {\n    style.setAttribute(\"nonce\", nonce);\n  }\n}\n\nmodule.exports = setAttributesWithoutAttributes;\n\n//# sourceURL=webpack://task02_conversion_types/./node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js?");
...
"use strict";
eval("\n\n/* istanbul ignore next  */\nfunction styleTagTransform(css, style) {\n  if (style.styleSheet) {\n    style.styleSheet.cssText = css;\n  } else {\n    while (style.firstChild) {\n      style.removeChild(style.firstChild);\n    }\n\n    style.appendChild(document.createTextNode(css));\n  }\n}\n\nmodule.exports = styleTagTransform;\n\n//# sourceURL=webpack://task02_conversion_types/./node_modules/style-loader/dist/runtime/styleTagTransform.js?");

/***/ }),

/***/ "./src/script/dataCollector.js":
/*!*************************************!*\
  !*** ./src/script/dataCollector.js ***!
  \*************************************/
/***/ ((module) => {

eval("module.exports = class DataCollector {\r\n    async getData (url) {\r\n        let data;\r\n        try {\r\n            const res = await fetch(`${url}`);\r\n            if (!res.ok) {\r\n                throw new Error(res.statusText);\r\n            }\r\n            data = await res.json();\r\n        } catch ({message}) {\r\n            throw new Error(message)\r\n        }\r\n        return data;\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack://task02_conversion_types/./src/script/dataCollector.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../style/style.scss */ \"./src/style/style.scss\");\n\r\nconst  Render = __webpack_require__(/*! ./render */ \"./src/script/render.js\");\r\n\r\nwindow.onload = function() {\r\n    new Render();\r\n};\n\n//# sourceURL=webpack://task02_conversion_types/./src/script/index.js?");
